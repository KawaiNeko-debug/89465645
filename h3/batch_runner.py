    ...
    normalized.update(
        {
            ...
            "account_format_error": truthy(raw.get("account_format_error")),
            "account_format_reason": str(raw.get("account_format_reason") or "").strip(),
            "risk_controlled": truthy(raw.get("risk_controlled")),
            "banned_account": truthy(raw.get("banned_account")),
            "points_fetch_success": truthy(raw.get("points_fetch_success")),
            ...
            "box_lottery": raw.get("box_lottery") if isinstance(raw.get("box_lottery"), list) else [],
        ...
        sanitized_results.append(
            {
                ...
                "account_format_error": item.get("account_format_error", False),
                "account_format_reason": item.get("account_format_reason", ""),
                "risk_controlled": item["risk_controlled"],
                "banned_account": item.get("banned_account", False),
                "points_fetch_success": item.get("points_fetch_success", False),
                "activity_fetch_success": item.get("activity_fetch_success", False),
                "data_fetch_completed": item.get("data_fetch_completed", False),
                ...
                "activity_records": item.get("activity_records") or {"seckill": [], "lottery": [], "exchange": []},
                "box_lottery_required": item.get("box_lottery_required", False),
                "box_lottery": item.get("box_lottery") or [],
